...
*/
	player createDiaryRecord["changelog",
		[
			"Official Change Log",
				"
					The official change log can be found on the HeroesOfGaming forums (search http://heroesofgaming.co.uk)
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Speeding", 
				...
				Small roads: 60km/h<br/>
				Main roads: 60km/h<br/><br/>
				Outside major cities:<br/>
				Small roads: 100km/h<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Chain of Command",
				...
				1. Police Community Support Officer (PCSO)<br/>
				2. Police Constable (PC)<br/>
				3. Senior Police Constable (SPC)<br/>
				4. Sergeant (SGT)<br/>
				5. Inspector (INSP)<br/>
				6. Chief Inspector (C/INSP)<br/>
				7. Superintendent (SUPT)<br/>
				8. Chief Superintendent (C/SUPT)<br/>
				9. Chief Constable (CC)<br/><br/>
	...
	player createDiaryRecord ["illegalitems",
		[
			"Illegal Vehicles",
				...
				2. Speedboat<br/>
				3. Hunter<br/>
				4. Police Vehicles Under Civilians<br/>
				"
		]
	];
	player createDiaryRecord ["illegalitems",
