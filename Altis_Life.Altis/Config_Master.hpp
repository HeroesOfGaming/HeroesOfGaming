...
class Life_Settings {
	...
	/* Impound Variables */
	impound_car = 1200; //Price for impounding cars
	impound_boat = 1200; //Price for impounding boats
	impound_air = 1200; //Price for impounding helicopters / planes
...
class Licenses {
	...
	LICENSEMACRO(advanced_rebel,"STR_License_advanced_rebel","advanced_rebel",10000000,true,"civ")
	LICENSEMACRO(corporation,"STR_License_corporation","corporation",3000000,true,"civ")
	LICENSEMACRO(advanced_corporation,"STR_License_advanced_corporation","advanced_corporation",10000000,true,"civ")
};
