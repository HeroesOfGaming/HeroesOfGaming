...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "advanced_rebel": {_var = "license_civ_advanced_rebel"}; //Advanced Rebel License
			case "corporation": {_var = "license_civ_corporation"}; //Corporation License
			case "advanced_corporation": {_var = "license_civ_advanced_corporation"}; //Advanced Corporation License
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_advanced_rebel": {_var = "advanced_rebel"}; //Advanced Rebel License
			case "license_civ_corporation": {_var = "corporation"}; //Corporation License
			case "license_civ_advanced_corporation": {_var = "advanced_corporation"}; //Advanced Corporation License
