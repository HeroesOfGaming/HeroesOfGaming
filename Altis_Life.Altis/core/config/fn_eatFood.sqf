...
if([false,_food,1] call life_fnc_handleInv) then {
	switch (_food) do
	{
		...
		case "rooster_grilled":{ _val = 50};
		case "hen_fried":{ _val = 50};
		case "turtle_soup":{ _val = 50};
		case "catshark_fried":{ _val = 50};
		case "mullet_fried":{ _val = 50};
		case "tuna_grilled":{ _val = 50};
		case "mackerel_grilled":{ _val = 50};
		case "ornate_grilled":{ _val = 50};
		case "salema_grilled":{ _val = 50};
		case "salema": {_val = 30};
		case "ornate": {_val = 25};
