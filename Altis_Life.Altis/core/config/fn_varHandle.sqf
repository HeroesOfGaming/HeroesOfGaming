...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "rabbit_grilled": {"life_inv_rabbit_grilled"};
			case "salema_grilled": {"life_inv_salema_grilled"};
			case "ornate_grilled": {"life_inv_ornate_grilled"};
			case "mackerel_grilled": {"life_inv_mackerel_grilled"};
			case "tuna_grilled": {"life_inv_tune_grilled"};
			case "mullet_fried": {"life_inv_mullet_fried"};
			case "catshark_fried": {"life_inv_catshark_friend"};
			case "hen_fried": {"life_inv_hen_fried"};
			case "rooster_grilled": {"life_inv_rooster_grilled"};
			case "sheep_grilled": {"life_inv_sheep_grilled"};
			case "goat_grilled": {"life_inv_goat_grilled"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_rabbit_grilled": {"rabbit_grilled"};
			case "life_inv_salema_grilled": {"salema_grilled"};
			case "life_inv_ornate_grilled": {"ornate_grilled"};
			case "life_inv_mackerel_grilled": {"mackerel_grilled"};
			case "life_inv_tune_grilled": {"tuna_grilled"};
			case "life_inv_mullet_fried": {"mullet_fried"};
			case "life_inv_catshark_friend": {"catshark_fried"};
			case "life_inv_hen_fried": {"hen_fried"};
			case "life_inv_rooster_grilled": {"rooster_grilled"};
			case "life_inv_sheep_grilled": {"sheep_grilled"};
			case "life_inv_goat_grilled": {"goat_grilled"};
