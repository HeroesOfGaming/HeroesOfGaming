...
switch (_type) do
{
	...
	case "advanced_rebel": {10000000}; //Advanced Rebel license cost
	case "corporation": {3000000}; //Corporation license cost
	case "advanced_corporation": {10000000}; //Advanced Corporation license cost
