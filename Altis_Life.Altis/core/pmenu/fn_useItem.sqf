...
switch (true) do {
	...
	case (_item in ["apple","rabbit","rabbit_grilled","salema_grilled","ornate_grilled","mackerel_grilled","tuna_grilled","mullet_fried","catshark_fried","rooster_grilled","sheep_grilled","goat_grilled","salema","ornate","mackerel","tuna","mullet","catshark","turtle","turtlesoup","donuts","tbacon","peach"]): {
